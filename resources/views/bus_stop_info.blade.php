    ...
    <p id="clock"></p>
     ...
     <table cellspacing="0">
        ...
        <tr>
           ...
           <td id="eta{{$key}}" eta_date="{{$value['eta_date']}}" eta_grace_check="NA">@if ($value['stop_eta'] != 'NA') @if($value['stop_eta'] > 1) {{$value['stop_eta']}} mins @else ARR @endif @else {{$value['stop_eta']}} @endif</td>
